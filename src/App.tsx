import { defineComponent, ref, watch, PropType, defineEmits, onMounted } from 'vue'
import "./style.css";
        ...
        return () => (
            <div>
                {/* <div style="height: 300px; overflow: hidden auto;"> */}
                    { urls.map(url => (<gorgeous-image key={url} src={url} class="w-full h-100" lazy lazyOffset={100}></gorgeous-image>)) }
                {/* </div> */}
            </div>
        )
    }
